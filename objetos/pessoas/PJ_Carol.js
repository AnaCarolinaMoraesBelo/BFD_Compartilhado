...
*/   
  ...
  getCNPJ() { //cria-se o método getCNJP para "pegar" o valor da variável;
    return this.#cnpj;
  }
  setEmail(email) { //cria-se um método para sobrescrever o método setEmail que foi herdado
/*
    Operadores de comparação:
      ==   : igualdade frouxa
      ===  : igualdade estrita
      ...
      !==  : diferença estrita
*/
    if (email !== '') { //verifica se o email é 
        if (email.includes('@')) { //
...
module.export = PJ_Carol; //exportando a classe